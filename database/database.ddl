...
create table ORDERS(CUS_ID varchar(20),ORD_ID int primary key not null,ORD_DATE datetime,ORD_ITEMSEL varchar(20),foreign key(CUS_ID) references CUSTOMER(CUS_ID) on delete cascade);
--create table WALLET
