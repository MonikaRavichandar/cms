...
create table CUSTOMER(CUS_ID int auto_increment not null primary key,CUS_PWD varchar(20),CUS_NAME varchar(30),CUS_DOB date,CUS_PH varchar(20),CUS_MAILADD varchar(30),CUS_WALLET float);
--  create table VENDOR
...
create table ORDERS(CUS_ID int(20),ORD_ID int primary key auto_increment not null,ORD_DATE datetime,ORD_ITEMSEL varchar(20),ORD_QTY int,foreign key(CUS_ID) references CUSTOMER(CUS_ID) on delete cascade);
--  create table WALLET
